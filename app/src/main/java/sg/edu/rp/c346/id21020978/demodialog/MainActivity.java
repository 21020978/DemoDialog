package sg.edu.rp.c346.id21020978.demodialog;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo4 = findViewById(R.id.btnD4);
        btnDemo5 = findViewById(R.id.btnD5);
        tvDemo5 = findViewById(R.id.tvD5);
        tvDemo4 = findViewById(R.id.tvD4);
...
*/
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                LayoutInflater inflater =
                        (LayoutInflater) getSystemService(Context.LAYOUT_INFLATER_SERVICE);
                View viewDialog = inflater.inflate(R.layout.input3, null);
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        // Extract the text entered by the user
                        int no = Integer.parseInt(etno1.getText().toString());
